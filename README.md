...
|-|-:|-:|-:|-:|-:|-:|-:|-:|-:|
|   |**code_1**|**code_2**|...|**code_m**|...|**code_1**|**code_2**|...|**code_m**|
|**date_1**|*data*|*data*|...|*data*|...|*data*|*data*|...|*data*|
|**date_2**|*data*|*data*|...|*data*|...|*data*|*data*|...|*data*|
|...|...|...|...|...|...|...|...|...|...|
...
通过自动循环实现单次查询数据量可超过原始API函数的限制，考虑Wind API存在7×24小时滚动数据查询量上限，当单次查询数据量过大时（默认为超过7×24小时最大查询量的1%）会自动提示。
